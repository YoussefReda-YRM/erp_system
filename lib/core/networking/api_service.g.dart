...
class _ApiService implements ApiService {
  ...
  @override
  Future<AttendanceResponse> getAllAttendance(String token) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{r'Authorization': token};
    _headers.removeWhere((k, v) => v == null);
  ...
  @override
  Future<List<GetAllVacationModel>> getAllVacations(String token) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{r'Authorization': token};
    _headers.removeWhere((k, v) => v == null);
  ...
  Future<ApplyVacationResponse> applyVacation(
    ApplyVacationRequest applyVacationRequest,
    String token,
  ) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
  ...
  Future<AddJobPositionResponse> addJobPosition(
    AddJobPositionRequest addJobPositionRequest,
    String token,
  ) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
  ...
  @override
  Future<List<GetAllPermissionResponse>> getAllPermission(String token) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{r'Authorization': token};
    _headers.removeWhere((k, v) => v == null);
  ...
  @override
  Future<List<GetAllScmOrdersModel>> getAllScmOrders(String token) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{r'Authorization': token};
    _headers.removeWhere((k, v) => v == null);
    const Map<String, dynamic>? _data = null;
    final _result = await _dio.fetch<List<dynamic>>(
        _setStreamType<List<GetAllScmOrdersModel>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    var value = _result.data!
        .map((dynamic i) =>
            GetAllScmOrdersModel.fromJson(i as Map<String, dynamic>))
        .toList();
    return value;
  }
  ...
  Future<AddScmOrderResponse> addScmOrder(
    AddScmOrderModel addScmOrderModel,
    String token,
  ) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    ...
    _headers.removeWhere((k, v) => v == null);
    final _data = <String, dynamic>{};
    _data.addAll(addScmOrderModel.toJson());
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<AddScmOrderResponse>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = AddScmOrderResponse.fromJson(_result.data!);
    return value;
  }
