...
class AddPermissionCubit extends Cubit<AddPermissionState> {
  ...
  AddPermissionCubit(this._addPermissionRepo)
      : super(AddPermissionInitial());
  ...
  void addPermission() async {
    ...
    final response = await _addPermissionRepo.addPermission(AddPermissionRequest(start: startTimeController.text
    ,end: endTimeController.text,date: dateController.text,description: descriptionController.text
