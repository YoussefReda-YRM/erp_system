...
class _UpdateVacationFormState extends State<UpdateVacationForm> {
  ...
  void initState() {
    ...
    context.read<UpdateVacationCubit>().startDateController.text =
        widget.getAllVacationModel.start.toString();

    context.read<UpdateVacationCubit>().endDateController.text =
        widget.getAllVacationModel.end.toString();

    context.read<UpdateVacationCubit>().descriptionController.text =
        widget.getAllVacationModel.description.toString();
  }
