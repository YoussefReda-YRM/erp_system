...
class SupplierListViewBodyAccounting extends StatelessWidget {
  SupplierListViewBodyAccounting(this.response, {super.key});
          ...
          return GestureDetector(
            onTap: () {
              GoRouter.of(context).push(
                AppRouter.kSupplierDetailsAccounting,
                extra: {
